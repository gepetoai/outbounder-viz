# Components Lab - Universal Sequencer

**Port: 3004** | http://localhost:3004

## Overview

This is the dedicated workspace for building universal components that will be used across all 248 apps (recruiter, inbounder, outbounder, researcher).
