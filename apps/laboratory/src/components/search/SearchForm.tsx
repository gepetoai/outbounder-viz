        ...
        <CardContent className="space-y-8 pt-2">
          ...
          <div className="border-b pb-6" style={{ borderColor: '#EEEEEE' }}>
            <div className="flex items-center gap-2 mb-4">
              <Icon src="/icons/book-dark.svg" alt="Education" size={20} />
          ...
          <div className="border-b pb-6" style={{ borderColor: '#EEEEEE' }}>
            <div className="flex items-center gap-2 mb-4">
              <Icon src="/icons/circle-dark.svg" alt="Location" size={20} />
          ...
          <div className="border-b pb-6" style={{ borderColor: '#EEEEEE' }}>
            <div className="flex items-center gap-2 mb-4">
              <Icon src="/icons/briefcase-dark.svg" alt="Experience" size={20} />
          ...
          <div className="border-b pb-6" style={{ borderColor: '#EEEEEE' }}>
            <div className="flex items-center gap-2 mb-4">
              <Icon src="/icons/check-dark.svg" alt="Inclusions" size={20} />
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <div className="space-y-1">
                  <Label className="text-xs" style={{ color: '#777D8D' }}>Keyword Inclusions</Label>
                  <div className="flex gap-2">
                    <Input
          ...
          <div className="border-b pb-6" style={{ borderColor: '#EEEEEE' }}>
            <div className="flex items-center gap-2 mb-4">
              <Icon src="/icons/xmark-dark.svg" alt="Exclusions" size={20} />
            ...
            {!contextId ? (
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <Icon src="/icons/circle-dark.svg" alt="Results" size={20} style={{ opacity: 0.4 }} />
                  <div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <Icon src="/icons/circle-dark.svg" alt="Results" size={20} />
                  <div>
