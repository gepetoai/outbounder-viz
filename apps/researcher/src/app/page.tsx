      ...
      <div className="flex h-screen bg-background">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          <main className="flex-1 overflow-auto p-6">
            <div className="mb-5">
              <h1 className="text-xl font-bold text-foreground">Researcher</h1>
              <p className="text-muted-foreground mt-2">Lead research and enrichment</p>
            </div>
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <CardDescription>
                        Research and enrich your lead database
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground">
                    This application is under development. Lead finder, list management, and enrichment features will be available soon.
                  </p>
                </CardContent>
              </Card>
            </div>
